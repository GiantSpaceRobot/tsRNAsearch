...
# Look for exp_layout file. Use predicted one if it's not there.
# Use find to get all .genomecov files related to each condition.
# Paste files together. Calculate mean and stdev in added columns.
