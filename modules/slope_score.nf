...
process SLOPE_SCORE {
    ...
    path("*high-slope-score.tsv"), emit: combined_features
    path("*tRNAs*slope-score.tsv"), emit: tsRNA_features
    path("*ncRNAs*slope-score.tsv"), emit: ncRNA_features
    path("*.pdf"), emit: pdfs
    ...
    SlopeScore.R \\
        ...
        $gtf &
    wait
    cat *high-slope-score.tsv | grep -v ^feat | awk '{print \$1}' \\
