...
Rscript scripts/Five-vs-Threeprime_CompareConditions-normalise-v4.R $myPath/$outDir/Results/Data/Intermediate-files/tiRNA.condition1_concatenated.depthVert $myPath/$outDir/Results/Data/Intermediate-files/tiRNA.condition2_concatenated.depthVert $myPath/$outDir/Results/Data/Intermediate-files/${condition1}_vs_${condition2}_tiRNAs &
Rscript scripts/Five-vs-Threeprime_CompareConditions-normalise-v4.R $myPath/$outDir/Results/Data/Intermediate-files/snomiRNA.condition1_concatenated.depthVert $myPath/$outDir/Results/Data/Intermediate-files/snomiRNA.condition2_concatenated.depthVert $myPath/$outDir/Results/Data/Intermediate-files/${condition1}_vs_${condition2}_snomiRNAs &
wait
...
#cp -r $myPath/$outDir/Results/Data/Intermediate-files/DE_Results/ $myPath/$outDir/Results/Data/
