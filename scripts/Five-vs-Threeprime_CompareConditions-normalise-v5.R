...
###------------------------------------------------------------------------------
### 
### This script calculates 5' to 5' ratio and 3' to 3' ratio between conditions, then the resulting ratio between these (5' to 3')
### 
###-------------------------------------------------------------------------------
...
for(subset1 in df1) {
  ...
  if(is.infinite(ratio5prime) || is.nan(ratio5prime)){
    ratio5vs3 <- 0
  } else if(is.infinite(ratio3prime) || is.nan(ratio3prime)){
    ratio5vs3 <- 0
...
newdata <- newdata[ which(newdata$median.coverage > 10), ] # Mean RPM must be 10 or more across both conditions for each feature 
