...
#input1 <- read.table("/home/paul/Documents/Pipelines/tirna-pipeline/subset4//Results/Data/Intermediate-files/tiRNA.condition1_concatenated.depthVert")

#input2 <- read.table("/home/paul/Documents/Pipelines/tirna-pipeline/subset4/Results/Data/Intermediate-files/tiRNA.condition2_concatenated.depthVert")
