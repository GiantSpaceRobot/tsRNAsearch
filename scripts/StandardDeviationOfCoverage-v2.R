...
my.list = list("feature", "sum.of.percent", "mean.of.percent", "mean.of.difference", "stddev.of.difference", "coef.of.variation",	"Fragment retained in:")
write.table(my.list, 
            file = "/home/paul/Documents/Pipelines/tirna-pipeline/TOPHAT-FullTest/Results/Data/NewMethod.txt",
            #file = args[2],
            quote = FALSE, 
            append = TRUE,
            sep = "\t",
...
for(feature in featuresUnion) {
  ...
  my.list <- list(feature, sum.of.percent, mean.of.percent, mean.of.difference, stddev.of.difference, coef.of.variation, paste0("Condition ", condition))
  write.table(my.list, 
              file = "/home/paul/Documents/Pipelines/tirna-pipeline/TOPHAT-FullTest/Results/Data/NewMethod.txt",
              #file = args[2],
              append = TRUE, 
