...
input1 <- read.table("/home/paul/Documents/Pipelines/tirna-pipeline/Full-test/Results/Data/Intermediate-files/Distribution-score/sorted1.txt")

input2 <- read.table("/home/paul/Documents/Pipelines/tirna-pipeline/Full-test/Results/Data/Intermediate-files/Distribution-score/sorted2.txt")
...
newdata <- newdata[newdata$`5vs3.ratio.percent` > 150, ] # Get high 5' / 3' ratios
...
#       subtitle = NULL)
pdf(file = paste0("Documents/Pipelines/tirna-pipeline/Full-test/Results/Plots/Ang_vs_Veh.potentially-cleaved-features.pdf"), width = pdf.width, height = 3)
