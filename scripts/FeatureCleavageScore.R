...
#input1 <- read.table("/home/paul/Documents/Pipelines/tirna-pipeline/Full-test2/Results/Data/Intermediate-files/Distribution-score/sorted_tiRNA.condition1_concatenated.depth.mean")

#input2 <- read.table("/home/paul/Documents/Pipelines/tirna-pipeline/Full-test2/Results/Data/Intermediate-files/Distribution-score/sorted_tiRNA.condition2_concatenated.depth.mean")
...
ggplot(data = newdata, mapping = aes(feature, newdata$mean.x.ratio, color=newdata$mean.x.ratio)) +
  geom_point() +
