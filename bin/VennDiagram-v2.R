...
input1 <- read.table("/home/paul/Documents/Pipelines/tsRNAsearch/Runs/Full_Ang-vs-Veh/Results/Data/DE_Results/DESeq2/DEGs_names-only_short-names.txt")
input2 <- read.table("/home/paul/Documents/Pipelines/tsRNAsearch/Runs/Full_Ang-vs-Veh/Results/Data/Intermediate-files/Distribution-score/High-distribution-scores_feature-names.txt")
input3 <- read.table("/home/paul/Documents/Pipelines/tsRNAsearch/Runs/Full_Ang-vs-Veh/Results/Data/Intermediate-files/Potentially-cleaved-features_feature-names.txt")
...
VennDiagram::draw.triple.venn(area1 = DE, area2 = HD, area3 = PC)
